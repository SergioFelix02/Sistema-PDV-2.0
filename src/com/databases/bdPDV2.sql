...
as
begin
    insert into Ventas (idSucursal, idUsuario, subtotal, iva, total, fecha)
    values (@idSucursal, @idUsuario, @subtotal, @iva, @total, getDate())
end
go
...
as
begin
    insert into Usuarios (usuario, contrasena, permisos, estatus)
    values (@usuario, @contrasena, @permisos, @estatus)
end
go
